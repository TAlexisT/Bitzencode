  ...
  return (
    <footer className="bg-black text-white py-8">
      <div className="container mx-auto px-4">
        ...
        <nav className="mb-6">
          <ul className="flex justify-center flex-wrap gap-6 md:gap-12 lg:gap-16">
            <li>
              <a
                href="/"
        ...
        {/* Redes Sociales */}
        <div className="flex justify-center space-x-6 mb-10 mt-10">
          {/* Facebook */}
          <a
            href="#"
        ...
        <div className="text-center">
          <p className="text-gray-400 text-sm">
            © 2025 Bitzencode. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
